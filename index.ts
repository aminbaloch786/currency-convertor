...
while (loop) {
  ...
  if (input === "Pakistani Rupee") {
    if (output === "US Dollar") {
      console.log(
        `The ${amount} Pakistani Rupee is equal to ${(
          amount / 300
        ).toFixed(2)} US Dollar`
      );
    ...
    if (output === "Pakistani Rupee") {
      console.log(
        `The ${amount} US Dollar is equal to ${(amount * 300).toFixed(
          2
        )} Pakistani Rupee`
      );
    } else if (output === "Saudi Riyal") {
      console.log(
        `The ${amount} US Dollar is equal to ${(amount * 3.75).toFixed(
          2
        )} Saudi Riyal`
      );
    }
    ...
    if (output === "Pakistani Rupee") {
      console.log(
        `The ${amount} Saudi Riyal is equal to ${(amount * 75).toFixed(
          2
        )} Pakistani Rupee`
      );
    } else if (output === "US Dollar") {
      console.log(
        `The ${amount} Saudi Riyal is equal to ${(amount * 3.75).toFixed(
          2
        )} US Dollar`
      );
    }
